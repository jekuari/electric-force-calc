...
export default function App(): ReactElement {
  ...
  const [measureUnits, setMeasureUnits] = useState<MeasureUnits>(
    MeasureUnits.m,
  );
  ...
  const handleCalculate = () => {
    const res = calculateResultingForce(
      charge1,
      charge2,
      charge3,
      inRelationTo,
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100 gap-4">
      <div className="max-w-[800px] w-full p-4 bg-white rounded-lg shadow-lg flex flex-col gap-4">
        ...
        <SimplifiedInputSelect
          title="Calculate in relation to"
          setter={setInRelationTo}
          value={inRelationTo}
          options={["charge1", "charge2", "charge3"]}
        />
        <SimplifiedInputSelect
          title="Measure units"
          setter={setMeasureUnits}
          value={measureUnits}
          options={[
            MeasureUnits.m,
            MeasureUnits.cm,
